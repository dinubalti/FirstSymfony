...
function createUserForm() {
    var roleProxy = new Ext.data.HttpProxy({
        url: Routing.generate('user_role_list')
    });
...
function createGroupGrid(){
    var proxy = new Ext.data.HttpProxy({
        url: Routing.generate('user_group_list')
    });
...
function modifyUser(data) {
    ...
    Ext.getCmp('confirmPasswordField').setValue(data.password);
...
function saveUser() {
    ...
    if (isBlank(Ext.getCmp('confirmPasswordField').getValue())) {
        validationMessage += 'Campul "Confirma parola" este gol!' + '</br>';
    }
    if (!isBlank(Ext.getCmp('passwordField').getValue()) && 
            !isBlank(Ext.getCmp('confirmPasswordField').getValue()) && 
            (Ext.getCmp('confirmPasswordField').getValue() !== Ext.getCmp('passwordField').getValue())) {
        validationMessage += 'Parolele nu coincid!' + '</br>';
    }
...
function deleteUser(userId) {
    Ext.Msg.show({
        ...
        msg : 'Sunteti sigur ca stergeti acest utilizator?',
...
function resetFields() {
    ...
    Ext.getCmp('confirmPasswordField').setValue('');
